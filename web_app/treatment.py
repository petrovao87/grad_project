...
def treatment(filename, min_binary, max_binary, min_contour_area, max_contour_area):
    ...
    # Поиск и нанесение контуров на исходное изображение (findContours - contourArea - drawContours)
    ...
    print('Средний диаметр - ', '%.2f' % medium_phase_size, 
        'нм, ', 'количество исследованных частиц - ',
            len(contour_in_nano))
